export const romanceSpecialMinimalV11 = {
  "id": "romance-special-minimal-v1-1",
  "title": "恋爱特化表_精简版v1.1",
  "databaseKey": "romance-special-minimal-v1-1",
  "template": {
    "mate": {
      "type": "chatSheets",
      "version": 2,
      "fusionMeta": {
        ...
        "generatedAt": "2026-07-12T10:06:54.412Z",
        "sources": [
          {
            "origin": "A",
            "sourceId": "local:TavernDB_template_恋爱特化表_精简版.json",
            "name": "TavernDB_template_恋爱特化表_精简版.json",
            "sheetCount": 8,
            "sheets": [
              {
                "key": "sheet_global_data",
                "outputSheetKey": "sheet_global_data",
                "name": "全局状态表"
              },
              {
                "key": "sheet_world_map",
                "outputSheetKey": "sheet_world_map",
                "name": "场景地点表"
              },
              {
                "key": "sheet_protagonist",
                "outputSheetKey": "sheet_protagonist",
                "name": "主角信息表"
              },
              {
                "key": "sheet_important_non_romance",
                "outputSheetKey": "sheet_important_non_romance",
                "name": "重要角色表"
              },
              {
                "key": "sheet_romance_diary",
                "outputSheetKey": "sheet_romance_diary",
                "name": "恋爱日记表"
              },
              {
                "key": "sheet_summary",
                "outputSheetKey": "sheet_summary",
                "name": "纪要表"
              },
              {
                "key": "sheet_bwxtt33d5",
                "outputSheetKey": "sheet_bwxtt33d5",
                "name": "检定建议表"
              },
              {
                "key": "sheet_dwj6ltghl",
                "outputSheetKey": "sheet_dwj6ltghl",
                "name": "导演规划表"
              }
            ]
          },
          {
            "origin": "B",
            "sourceId": "local:TavernDB_template_YO-骰子-恋爱特化表v7.3（适配双人成行）.json",
            "name": "TavernDB_template_YO-骰子-恋爱特化表v7.3（适配双人成行）.json",
            "sheetCount": 4,
            "sheets": [
              {
                "key": "sheet_escyvvs2u",
                "outputSheetKey": "sheet_escyvvs2u",
                "name": "才艺技能表"
              },
              {
                "key": "sheet_inventory",
                "outputSheetKey": "sheet_inventory",
                "name": "物品表"
              },
              {
                "key": "sheet_outfits",
                "outputSheetKey": "sheet_outfits",
                "name": "装扮表"
              },
              {
                "key": "sheet_memo",
                "outputSheetKey": "sheet_memo",
                "name": "备忘录"
              }
            ]
          }
    ...
    "sheet_wu_pin_biao": {
      ...
      "sourceData": {
        ...
        "deleteNode": "禁止。\n\n",
        "updateNode": "物品变化时更新。可堆叠物品不新建重复行。",
