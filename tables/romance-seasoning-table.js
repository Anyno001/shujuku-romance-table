export const romanceSeasoningTable = {
  "id": "romance-seasoning-table",
  "title": "恋爱调味表",
  "databaseKey": "romance-seasoning-table",
  "template": {
    "mate": {
      "type": "chatSheets",
      "version": 1,
      "fusionMeta": {
        ...
        "generatedAt": "2026-08-18T14:10:29.770Z",
        "sources": [
          {
            "origin": "A",
            "sourceId": "local:恋爱精简表_带网络版(1).json",
            "name": "恋爱精简表_带网络版(1).json",
            "sheetCount": 10,
            "sheets": [
              {
          ...
          {
            "origin": "B",
            "sourceId": "local:世界控制表.json",
            "name": "世界控制表.json",
            "sheetCount": 1,
            "sheets": [
              {
                "key": "sheet_WorldCtrl",
                "outputSheetKey": "sheet_WorldCtrl",
                "name": "世界控制表"
              }
            ]
          }
    ...
    "sheet_WorldCtrl": {
      ...
      "name": "世界控制表",
      "sourceData": {
        "note": "控制通用世界书的开关状态。此表有且仅有一行。\n- 列0: 行标识 - 固定填「当前世界模式」，用于配合世界书的三段式 <if cell> 路径定位。\n- 列1: 类型 - 当前启用的体质体系。合法值: ABO / 哨向 / 蛋糕叉 / 虫族。留空=不启用任何体系。互斥，一次只能填一个。\n- 列2: 风格 - 当前世界观的术语风格。合法值: 东方 / 西幻 / 科幻。留空=走通用兜底。\n- 列3: 附加设定 - 当前启用的附加种族/特征层。合法值: 猫 / 植物 / 天使恶魔。留空=不启用。互斥，一次只能填一个。\n- 列4: user预设 - user角色的身体/身份预设。合法值随类型联动：\n  · 类型=ABO时: 默认 / 双性 / 纯男性Omega / 女性Omega\n  · 类型=虫族时: 虫母 / 虫皇\n  · 其他类型或留空时: 默认\n  留空等同于默认（不额外干预user身体描述）。",
        "initNode": "插入一行，列0（行标识）固定填「当前世界模式」，其余列根据用户选择填入对应值。不确定的列填空。",
        "deleteNode": "禁止删除。",
        "updateNode": "用户明确要求切换世界观类型、风格、附加设定或user预设时更新对应列。切换类型时同步检查user预设是否仍合法，不合法则清空为默认。",
        "insertNode": "禁止操作。此表永远只有一行。"
      },
      "content": [
        [
          "行标识",
